...
export default function PlanetSystem() {
  return (
    ...
    {/* === 🌈 MOVING AURORA RIBBON === */}
      ...
      {/* === Orbit 1: Earth === */}
      <div className="absolute w-[500px] h-[500px] rounded-full border border-blue-400/20 animate-spin-slow shadow-[0_0_30px_10px_rgba(0,191,255,0.15)]">
        <img
          src={earth}
          alt="Earth"
      ...
      {/* === Orbit 2: Mars === */}
      <div className="absolute w-[700px] h-[700px] rounded-full border border-red-500/25 animate-spin-reverse shadow-[0_0_40px_10px_rgba(255,69,0,0.12)]">
        <img
          src={mars}
          alt="Mars"
      ...
      {/* === Orbit 3: Uranus === */}
      <div className="absolute w-[900px] h-[900px] rounded-full border border-cyan-400/25 animate-spin-slower shadow-[0_0_60px_15px_rgba(0,255,255,0.15)]">
        <img
          src={uranus}
          alt="Uranus"
